...
from services.gateway.deps.project import UserProjectByPathAnyAuth
...
async def create_task(
    ...
    user: UserDepends,
    project: UserProjectByPathAnyAuth,
    payload: Annotated[TaskCreateRequest | None, Body] = None,
    ...
    target_nodes: Annotated[
        list[str] | None,
        Query(
            description="Список целевых узлов для выполнения",
        ),
    ] = None,
):
