...
from core.metadata.db_metadata.helpers import _rows_to_db_tables, build_database_db_metadata
from core.types import DBMetadata


def load_clickhouse_metadata(engine: sa.Engine) -> DBMetadata:
    with engine.connect() as conn:
        database_rows = conn.execute(sa.text("""
