...
### 2026-09-08 13:21:20
- Обновлен корневой README: добавлены ссылки на документацию и поддержку, ссылка на русскую версию и создан полный русский перевод README в docs/REAMDE.ru.md.
...
### 2026-09-22 15:11:42
- Добавлен общий навык работы с проектами DVT через MCP с разделами по подключению, графам и интеграциям; подключены инструкции для AI-агентов.

### 2026-09-22 15:13:53
- Инструкции Claude перенесены из корня репозитория в `.claude/CLAUDE.md`.

### 2026-09-22 15:16:14
- В общий навык DVT MCP добавлена инструкция по безопасному сохранению переменной DVT_DEV_MCP_TOKEN в Windows PowerShell.

### 2026-09-22 15:24:45
- Расширен общий навык DVT MCP для всех AI: добавлены подробные правила выбора узлов, обработки таблиц, сегментации, join и union, записи, запусков, диагностики и проверки результата; настройки Codex выделены как пример клиента.

### 2026-09-22 16:46:45
- Обновлена инструкция подключения DVT MCP: добавлен проверяемый скрипт сохранения токена и универсальный пример URL для инсталляций заказчиков.

### 2026-09-22 16:57:45
- Добавлена инструкция навыка DVT MCP по пакетной полной выгрузке Битрикс24 и переходу на инкрементальную загрузку через контрольную дату и upsert.

### 2026-09-22 17:03:48
- Дополнена инструкция DVT MCP по Битрикс24: разграничены документационный MCP и REST портала, описаны методы получения типов CRM и фактических имен полей.

### 2026-09-22 17:07:43
- Дополнена инструкция DVT MCP по Битрикс24: описана загрузка таймлайна сделок и лидов, а также ограничение текущего коннектора для таймлайна смарт-процессов.

### 2026-09-22 17:11:01
- Уточнена инструкция DVT MCP по Битрикс24: поле контрольной даты выбирается по схеме сущности; проверены примеры лидов, сделок и задач, описан случай отсутствия даты изменения.

### 2026-09-22 17:18:14
- Дополнен навык Битрикс24: выгрузка задач, времени, результатов и истории по графу DVT; уточнён исправленный вход истории; добавлены отдельное лицензирование расширения и оркестрация групп сущностей через главный проект.

### 2026-09-22 17:20:39
- Раздел о коммерческой доступности расширения Битрикс24 перенесён в начало справочника навыка.

### 2026-09-22 17:25:57
- В общий навык DVT добавлен шаблон атомарных проектов в папке, головного пайплайна через ExecuteProject и расписания головного проекта. Из текстов навыка удалены адреса внутренних DVT-порталов, идентификаторы реальных проектов и внутренние имена из примеров.

### 2026-09-22 17:28:15
- В общем навыке DVT уточнено управление расписанием головного проекта через Gateway API: создание, изменение, отключение, удаление и чтение; различены действия unschedule и delete.

### 2026-09-24 13:07:01
- Исправлено восстановление очередей Celery после обновления расширений: выбранные очереди и их exchange/routing key сохраняются при пересоздании consumer. Добавлен регрессионный тест; 51 unit-тест воркера проходит.

### 2026-09-25 22:13:24
- Исправлена идентичность расширений: маршруты и runtime используют каноническое имя пакета, старые имена разрешаются как aliases. Добавлена миграция 0062 с сохранением UUID, состояния и физической PostgreSQL-схемы; обновлён RELEASE. Унифицированы разрешение схем и блокировки состояния, сохранение aliases при переустановке и удаление данных по явному флагу. Добавлены регрессионные и PostgreSQL-интеграционные проверки, описан порядок обновления.
