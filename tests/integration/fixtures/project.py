...
def test_admin_project(test_db_session, test_admin_user) -> Generator[ProjectRecord, Any]:
...
@pytest.fixture(scope="function")
def test_user_project(test_db_session, test_user) -> Generator[ProjectRecord, Any]:
