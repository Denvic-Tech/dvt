...
## Документация и внешни ссылки

- Основная пользовательская документация размещена на: https://docs.denvic.tech/dvt_docs/dvt_docs/
...
- Движок исполнения pipeline - Dask;
...
- Визуальный планировщик запуска проектов по cron;
